...
- [x] Convert "Book Now" section into a "Get a Quote" section — *done 2026-09-15, section renamed to `#quote` (eyebrow, title, subtitle, submit button) and every Book Now/Book This CTA site-wide (utility bar, nav, hero, 3 pricing cards) relabeled "Get a Quote". Form field set unchanged — see Open Decisions below.*
- [ ] Point "Get a Quote" (nav + buttons) to an external booking site instead of the on-page form
...
- [ ] Which external site should "Get a Quote" redirect to? (Jobber, Square Appointments, Calendly, etc.)
...
- Pushed through commit `18274d6`. **Not yet pushed:** Book Now → Get a Quote conversion and this TODO update (local commit `da4bb33` and later).
